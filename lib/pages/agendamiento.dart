...
class ReservarCita extends StatefulWidget {
  ReservarCita({Key key, this.title, this.nombre, this.codigo})
      : super(key: key);
  final String nombre;
  final String codigo;
  final String title;
  @override
  _ReservarCitaState createState() =>
      _ReservarCitaState(nombreUsuario: nombre, codeUsuario: codigo);
}
...
class _ReservarCitaState extends State<ReservarCita> {
  ...
  String nombreUsuario = "";
  String codeUsuario = "";
  _ReservarCitaState({this.nombreUsuario, this.codeUsuario});
  String id;
  int totalParticipantes;
  int capacidad;
  @override
