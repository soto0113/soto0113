...
import 'package:ayudafinal/pages/mis_reservas.dart';
...
class _State extends State<Reserves> {
  ...
  CollectionReference reference = Firestore.instance.collection(Constants.reservasCollectionId);
  List listaHoras = [];
  ...
  inicializaReservas(fecha, hora_inicio, num_horas) {
    ...
    for (var i = 0; i < num_horas; i++) {
      ...
      fecha_actual = fecha_actual.add(new Duration(minutes: 60));
    }
  }
